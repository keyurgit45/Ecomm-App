...
exports.adminUpdateUserData = BigPromise( async (req, res, next) => {
    const userId = req.params.id

    if(!req.body.name || !req.body.email || !req.body.role) return next( new Error ('Name, Email and Role are required') )
